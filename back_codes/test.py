...
if __name__ == "__main__":
    os.chdir("C:\\Users\\SOS\\PycharmProjects\\pythonProject2\\data")
    ...
    tsA = [1,4,5,6,9,8,7,4,5,6,2,1,7,8,4,5,4,5,4,5,4,5,1,5,1,5,1,41,7,7,458,4,8,4,8,4,84,8,4,4,5,4,5,1,58,47,4,1,5,4,5,6,2,1,7,8,4,5,4,]
    #results = holtWinters(tsA, 12, 4, 24, mtype = 'additive')
    results = holtWinters(tsA, 2, 2, 4, mtype = 'multiplicative')
